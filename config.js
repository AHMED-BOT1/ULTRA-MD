...
const defaultOwner = '201554223192';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '201554223192';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'ᎯᎻᎷᎬᎠ';
global.pairingNumber = process.env.BOT_NUMBER || '201554223192';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'session id';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['201554223192', '201554223192']
